// Tablero de rentabilidad — markup transcrito VERBATIM del entregable de
// Claude Design (design/tablero-financiero/), con datos reales.
//
// La diferencia con /admin/dinero: aquel es un tablero de INGRESOS (cuánto
// entró); este es de RENTABILIDAD (de lo que entró, cuánto es mío). Por eso la
// unidad es la SALIDA y no la experiencia: los costos fijos se pagan una vez
// por salida, y agregados por experiencia el punto de equilibrio desaparece.
//
// Tres niveles de <details> nativos, sin JavaScript: mes → salida → cascada →
// tabla de detalle.
...
export default async function RentabilidadPage() {
  const salidas = await fetchRentabilidad();
    ...
    <>
      <header className="ahead">
        <div className="top">
          ...
          <div className="qa">
            <Link className="btn btn-glass btn-sm" href="/caminante/admin/dinero">
              Ver ingresos
            </Link>
          </div>
        </div>
        <nav className="nav">
          <Link href="/caminante/admin">Panorama</Link>
          <Link href="/caminante/admin/eventos">Eventos</Link>
          <Link href="/caminante/admin/reservas">Reservas</Link>
          <Link href="/caminante/admin/personas">Personas</Link>
          <Link href="/caminante/admin/dinero">Dinero</Link>
          <a href="#" className="on">
            Rentabilidad
          </a>
          <Link href="/caminante/admin/encuesta">Encuesta</Link>
        </nav>
      </header>
