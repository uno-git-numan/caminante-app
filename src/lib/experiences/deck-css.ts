...
/* La fecha SIEMPRE en el naranja del logo (var(--orange), el del sello) — así se
   lee sobre cualquier fondo. Sin sombra: limpio, como el logo. */
.s-meta{font-family:"Geist Mono",monospace;font-size:12px;font-weight:600;letter-spacing:.16em;text-transform:uppercase;color:var(--orange);}
