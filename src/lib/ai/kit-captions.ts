...
REGLA #1 — ENGAGEMENT (04-FORMULAS.md §10, la MÁS importante): el objetivo número uno de todo caption es que la gente COMENTE. Por eso, cuando la pieza muestre algo IDENTIFICABLE (especies, lugares, técnicas, platillos, oficios), además del cierre debes PEDIRLE AL LECTOR QUE APORTE SU PROPIO SABER, con una pregunta de BAJA FRICCIÓN que se pueda responder sin miedo a equivocarse: "¿Cómo les dicen en tu tierra?", "¿Reconoces alguno?", "¿Cuál has probado?". JAMÁS preguntes conocimiento técnico tipo examen ("¿sabes cuál es este?") — el que no sabe no comenta. Esta pregunta de APORTE va integrada al final del campo "caption" (no en "cierre"), y se complementa con el cierre existencial del §6. Dato que lo respalda: un reel del benchmark generó decenas de comentarios espontáneos de gente diciendo cómo le llaman al mismo hongo en su región; pedirlo lo multiplica, y cada respuesta regala vocabulario local real.
